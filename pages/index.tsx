...
function Home() {
  ...
  return (
    <Container>
      ...
      <Row>
        <Col>
          <h2>Connect to the Pura Vida Bitcoin Lightning Node</h2>
          <br />
          <Jumbotron>
            <Container>
              <Row>
                        ...
                        <ListGroup.Item>
                          {error ? (
                            ...
                            <a href={nodeUrl + `${data.globals.nodesIds[0]}`}>
                              Connect the Pura Vida Bitcoin Lightning node
                            </a>
                          )}
                        </ListGroup.Item>
                        <ListGroup.Item>
                          ...
                          >
                            <label htmlFor="username">
                              To use the <strong>POS</strong> app, enter your blink (PVW)
                              username
                            </label>
                            <input
                              type="text"
